        ...
        package com.example.alphatroniks;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ToggleButton apagarTodo, luz1,luz2,luz3,ventilador;
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apagarTodo = (ToggleButton) findViewById(R.id.ApagarTodo);
        luz1 = (ToggleButton) findViewById(R.id.luz1);
        luz2 = (ToggleButton) findViewById(R.id.luz2);
        luz3 = (ToggleButton) findViewById(R.id.luz3);
...
/*
        ...
        apagarTodo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
